...
usart_tx_string(data1, sizeof(data1));
  zt='r';
  kzfold='f';
  kzfnew='r';
  while(1)
  {
    ...
    if(RX_flag == 1)
    {
     ...
     if (kzfnew!='r' && kzfnew!='f')//temp=s
      {                  
        usart_tx_string("输入指令错----",sizeof("输入指令错----"));//kefnew=s
        kzfnew=kzfold;
      }
