...
void main( void )
{
    ...
    InitUart0();
    LCD_Init();
    LCD_P6x8Str(0, 1, "light AO VOLTAGE");
    ...
    while(1)
    {
        ...
        light = (uint16)(((float)adc/2048.0)*100);
                
        //变成可视的字符输出
        sprintf(buff, "v:%04d mv, light:%d", vol,light);
        ...
        //lcd 显示
        LCD_P6x8Str(0, 6, buff);
        
       LCD_TextOut(0,2,"林圆圆");
        LCD_TextOut(0,4,"230715121025");
        Uart0SendString("\n", 1);          // 回车换行    
        Uart0SendString("林圆圆230715121025   ", strlen("林圆圆230715121025   "));
